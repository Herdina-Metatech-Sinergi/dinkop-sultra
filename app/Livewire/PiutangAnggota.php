...
class PiutangAnggota extends Component
{
    ...
    public function downloadPDF(){
        ...
        session(['piutang-anggota' => $anggota]);

        $_url = '/admin/cetak/piutang-anggota?identitas_koperasi_id='.$this->identitas_koperasi;
    ...
    public function render()
    {
        ...
        return view('livewire.piutang-anggota',$data);
    }
}
