...
class LaporanArusKas extends Component implements HasForms
{
    ...
    public function exportPDF()
    {
        try {
            ...
            $_url = '/admin/cetak/laporan-arus-kas?tgl_awal=' . $tgl_awal->toDateString() . '&tgl_akhir=' . $tgl_akhir->toDateString() . '&identitas_koperasi_id=' . $this->filters['identitas_koperasi_id'];
